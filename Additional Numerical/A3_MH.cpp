...
Rcpp::List MH_arma(arma::vec beta, arma::vec y, arma::mat x, arma::mat z, double nu){
  ...
  arma::mat curr_Gee(n, r), pro_Gee(n, r), beta_iter(p, (iter_sl + 1), arma::fill::zeros), beta_samples(p, 5000, arma::fill::zeros);
  arma::vec lambda(r), curr_lambda(r), pro_lambda(r), curr_beta(p), pro_beta(p); 
  ...
  beta_samples = beta_iter.tail_cols(5000);  
